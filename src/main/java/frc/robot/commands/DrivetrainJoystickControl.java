...
public class DrivetrainJoystickControl extends Command {
	...
	protected void execute() {
		Robot.drivetrain.joystickControl(Robot.joyLeft, Robot.joyRight, (Robot.control.getHeld(ControllerBase.Joysticks.LEFT_STICK,ControllerBase.JoystickButtons.BTN1) 
